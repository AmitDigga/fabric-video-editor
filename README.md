...
Fabric Video Editor is a video editor that runs in the browser. It is built with fabric.js, Next.js (a React framework), tailwindcss, and typescript. Inspired by invideo.io
